"""Smoke test de arranque (T031): el servidor inicia y registra exactamente las 4 tools."""
...
@pytest.mark.asyncio
async def test_el_servidor_registra_exactamente_las_4_tools():
...
@pytest.mark.asyncio
async def test_create_server_registra_las_4_tools_con_providers_simulados():
